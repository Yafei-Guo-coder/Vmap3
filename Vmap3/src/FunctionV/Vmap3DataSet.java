...
//                    File [] fs2 = fs1[i].listFiles();
//                    for (int k = 0; k < fs2.length; k++) {
//                        BuildVariationLibrary.TaxonRead tr = new BuildVariationLibrary.TaxonRead(fs2[k].getAbsolutePath());
//
//
//                        File f = new File (outDirS,"chr"+ PStringUtils.getNDigitNumber(3, chr)+".vcf.gz").getAbsolutePath();
//                        f.mkdir();
//                        sb.setLength(0);
